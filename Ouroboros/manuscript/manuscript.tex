...
\begin{table}[htbp]
\centering
\caption{Head-to-head noise mitigation comparison showing the recovery breakdown brackets $[$Fail, Succeed$]$ (at $5$ dB resolution using $500$ trials for pointwise and weak-form, and coarse SNR cutoffs for others).}
...
Weak-Form GL SINDy & [<20 dB, 20 dB] & [15 dB, 20 dB] & [15 dB, 20 dB] \\
